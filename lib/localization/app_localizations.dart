...
abstract class AppLocalizations {
  ...
  /// No description provided for @noSeatsLeft.
  ///
  /// In en, this message translates to:
  /// **'All seats are taken'**
  String get noSeatsLeft;

  /// No description provided for @yourAccountIsDisabled.
  ///
  /// In en, this message translates to:
  /// **'Your account is disabled'**
  String get yourAccountIsDisabled;

  /// No description provided for @yourAccountIsDisabledDescription.
  ///
  /// In en, this message translates to:
  /// **'Your account is disabled. Please contact support to open it back.'**
  String get yourAccountIsDisabledDescription;
  ...
  /// No description provided for @deleteChatRoom.
  ///
  /// In en, this message translates to:
  /// **'Delete Chat'**
  String get deleteChatRoom;

  /// No description provided for @deleteChatRoomConfirmation.
  ///
  /// In en, this message translates to:
  /// **'Are you sure you want to delete this chat?'**
  String get deleteChatRoomConfirmation;
  ...
  /// No description provided for @lookingForPassenger.
  ///
  /// In en, this message translates to:
  /// **'Looking for a passenger'**
  String get lookingForPassenger;

  /// No description provided for @lookingForCar.
  ///
  /// In en, this message translates to:
  /// **'Looking for a car'**
  String get lookingForCar;

  /// No description provided for @verificationApprovedPleaseRestart.
  ///
  /// In en, this message translates to:
  /// **'Verification approved, please restart the app'**
  String get verificationApprovedPleaseRestart;

  /// No description provided for @numberPlateDescription.
  ///
  /// In en, this message translates to:
  /// **'Your license plate is only visible to your passengers'**
  String get numberPlateDescription;

  /// No description provided for @youMustAcceptThePolicies.
  ///
  /// In en, this message translates to:
  /// **'You must accept the policies'**
  String get youMustAcceptThePolicies;
  ...
  /// No description provided for @howToResetPasswordAnswer.
  ///
  /// In en, this message translates to:
  ...
  String get howToResetPasswordAnswer;
  ...
  /// No description provided for @howToUpdateProfileAnswer.
  ///
  /// In en, this message translates to:
  /// **'Navigate to Settings > Profile, where you can edit your personal information, including your name, email, and profile picture.'**
  String get howToUpdateProfileAnswer;

  /// No description provided for @isDataSecure.
  ///
  /// In en, this message translates to:
  /// **'Is my data secure?'**
  String get isDataSecure;

  /// No description provided for @isDataSecureAnswer.
  ///
  /// In en, this message translates to:
  /// **'Yes, we use industry-standard encryption to protect your data. Your information is stored securely and never shared with third parties.'**
  ...
  /// No description provided for @howToDeleteAccountAnswer.
  ///
  /// In en, this message translates to:
  /// **'To delete your account, press the colored <cc>Delete Account</cc>.'**
  String get howToDeleteAccountAnswer;

  /// No description provided for @canChangeEmail.
  ///
  /// In en, this message translates to:
  /// **'Can I change my email address?'**
  String get canChangeEmail;

  /// No description provided for @canChangeEmailAnswer.
  ///
  /// In en, this message translates to:
  /// **'Yes, you can change your email address in Settings > Account > Email. You will need to verify your new email address.'**
  String get canChangeEmailAnswer;
  ...
  /// No description provided for @appRunningSlowly.
  ///
  /// In en, this message translates to:
  /// **'The app is running slowly'**
  String get appRunningSlowly;

  /// No description provided for @appRunningSlowlyAnswer.
  ///
  /// In en, this message translates to:
  /// **'Try clearing the app cache in Settings > Storage. If the problem persists, try reinstalling the app.'**
  String get appRunningSlowlyAnswer;

  /// No description provided for @howToReportBug.
  ///
  /// In en, this message translates to:
  /// **'How do I report a bug?'**
  String get howToReportBug;

  /// No description provided for @howToReportBugAnswer.
  ///
  /// In en, this message translates to:
  /// **'You can report bugs through Settings > Send Feedback > Report a Bug, or email our support team at support@example.com'**
  String get howToReportBugAnswer;
  ...
  /// No description provided for @waitingForDepartureTime.
  ///
  /// In en, this message translates to:
  /// **'Waiting for departure time, Please try again later'**
  String get waitingForDepartureTime;
  ...
  /// No description provided for @onlyOneSeatLeft.
  ///
  /// In en, this message translates to:
  /// **'Only one seat left!'**
  String get onlyOneSeatLeft;
