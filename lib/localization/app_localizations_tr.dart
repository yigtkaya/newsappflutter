...
class AppLocalizationsTr extends AppLocalizations {
  ...
  @override
  String get noInvites => 'Henüz davet yok';
  ...
  @override
  String get leftAReview => 'Bir yorum bırakın';
  ...
  @override
  String get noSeatsLeft => 'Tüm koltuklar dolu';

  @override
  String get yourAccountIsDisabled => 'Hesabınız devre dışı bırakıldı';

  @override
  String get yourAccountIsDisabledDescription =>
      'Hesabınız devre dışı bırakıldı. Lütfen destek ile iletişime geçin.';

  @override
  String get cancel => 'İptal';

  @override
  String get deleteChatRoom => 'Sohbeti Sil';
  ...
  @override
  String get currentLocation => 'Şu anki konum';

  @override
  String get lookingForPassenger => 'Yolcu arıyor';

  @override
  String get lookingForCar => 'Araç arıyor';

  @override
  String get verificationApprovedPleaseRestart =>
      'Doğrulama tamamlandı, lütfen uygulamayı yeniden başlatın';

  @override
  String get numberPlateDescription =>
      'Araç plakanızı yolcularınız dışında hiç kimse göremez';

  @override
  String get youMustAcceptThePolicies => 'Lütfen politikaları kabul edin';

  @override
  String get howToResetPassword => 'Şifremi nasıl sıfırlarım?';

  @override
  String get howToResetPasswordAnswer =>
      'Şifrenizi sıfırlamak için, giriş ekranına gidin ve \"Şifremi Unuttum\" seçeneğine dokunun. E-postanıza gönderilen talimatları izleyerek yeni bir şifre oluşturun.';
  ...
  String get howToUpdateProfileAnswer =>
      'Ayarlar > Profil\'e gidin, burada adınız, e-postanız ve profil fotoğrafınız dahil kişisel bilgilerinizi düzenleyebilirsiniz.';

  @override
  String get isDataSecure => 'Verilerim güvende mi?';

  @override
  String get isDataSecureAnswer =>
      'Evet, verilerinizi korumak için endüstri standardı şifreleme kullanıyoruz. Bilgileriniz güvenli bir şekilde saklanır ve üçüncü taraflarla paylaşılmaz.';
  ...
  String get howToDeleteAccountAnswer =>
      'Hesabınızı silmek için <cc>Hesabı Sil</cc> seçeneğine dokunun.';

  @override
  String get canChangeEmail => 'E-posta adresimi değiştirebilir miyim?';

  @override
  String get canChangeEmailAnswer =>
      'Evet, e-posta adresinizi Ayarlar > Hesap > E-posta\'dan değiştirebilirsiniz. Yeni e-posta adresinizi doğrulamanız gerekecektir.';

  @override
  String get technicalSupport => 'Teknik Destek';

  @override
  String get appRunningSlowly => 'Uygulama yavaş çalışıyor';

  @override
  String get appRunningSlowlyAnswer =>
      'Ayarlar > Depolama\'dan uygulama önbelleğini temizlemeyi deneyin. Sorun devam ederse, uygulamayı yeniden yüklemeyi deneyin.';

  @override
  String get howToReportBug => 'Hata nasıl bildirilir?';

  @override
  String get howToReportBugAnswer =>
      'Hataları Ayarlar > Geri Bildirim Gönder > Hata Bildir üzerinden veya support@example.com adresine e-posta göndererek bildirebilirsiniz';
  ...
  String get waitingForDepartureTime =>
      'Kalkış saati bekleniyor, lütfen daha sonra tekrar deneyin';

  @override
  String get pleaseEnterAReason => 'Lütfen bildirim için bir sebep girin';
  ...
  @override
  String get onlyOneSeatLeft => 'Tek koltuk kaldı!';
